...
cover: draft-to-blog/image-1.png
toc: true
---
# 数学建模论文写作

![image-1](draft-to-blog/image-1.png)

![image-2](draft-to-blog/image-2.png)

## 一、写作方法

### 1.1 论文标题

![image-3](draft-to-blog/image-3.png)

标题可以基于所使用的主要模型或方法来拟定，长度一般不超过 20 字。

![image-4](draft-to-blog/image-4.png)
...
![image-5](draft-to-blog/image-5.png)

![image-6](draft-to-blog/image-6.png)
...
![image-7](draft-to-blog/image-7.png)
...
![image-8](draft-to-blog/image-8.png)
...
![image-9](draft-to-blog/image-9.png)

![image-10](draft-to-blog/image-10.png)

#### 4.2.2 **例 2：时间充裕时**

![image-11](draft-to-blog/image-11.png)
...
![image-12](draft-to-blog/image-12.png)

也可以放在模型假设和符号说明后面作为单独 的一节

![image-13](draft-to-blog/image-13.png)

还可以针对每个问题将其写在模型建立中。

![image-14](draft-to-blog/image-14.png)
...
![image-15](draft-to-blog/image-15.png)

**2020B078**

![image-16](draft-to-blog/image-16.png)

**2019C308**

![image-17](draft-to-blog/image-17.png)
...
![image-18](draft-to-blog/image-18.png)

![image-19](draft-to-blog/image-19.png)

![image-20](draft-to-blog/image-20.png)
...
![image-21](draft-to-blog/image-21.png)

## 八、模型准备

![image-22](draft-to-blog/image-22.png)
...
![image-23](draft-to-blog/image-23.png)

建议采用左侧形式。

### 9.1 物理学类

![image-24](draft-to-blog/image-24.png)

![image-25](draft-to-blog/image-25.png)

### 9.2 优化类

![image-26](draft-to-blog/image-26.png)

![image-27](draft-to-blog/image-27.png)

![image-28](draft-to-blog/image-28.png)

### 9.3 使用已有模型

![image-29](draft-to-blog/image-29.png)

![image-30](draft-to-blog/image-30.png)

![image-31](draft-to-blog/image-31.png)

![image-32](draft-to-blog/image-32.png)
...
![image-33](draft-to-blog/image-33.png)

![image-34](draft-to-blog/image-34.png)

![image-35](draft-to-blog/image-35.png)

![image-36](draft-to-blog/image-36.png)
...
![image-37](draft-to-blog/image-37.png)

#### 9.4.1 开放类

![image-38](draft-to-blog/image-38.png)
...
![image-39](draft-to-blog/image-39.png)

![image-40](draft-to-blog/image-40.png)

变化可以从两个角度观察：1. 趋势；2. 斜率。例如，α 越大，y 越敏感。

##### 10.1.1.1 示例

![image-41](draft-to-blog/image-41.png)

![image-42](draft-to-blog/image-42.png)

![image-43](draft-to-blog/image-43.png)

![image-44](draft-to-blog/image-44.png)

![image-45](draft-to-blog/image-45.png)

#### 10.1.2 误差分析

指分析模型中的误差来源，或者估算模型中存在的误差，一般用于预测问题或者数值计算类问题。

![image-46](draft-to-blog/image-46.png)

![image-47](draft-to-blog/image-47.png)

![image-48](draft-to-blog/image-48.png)

![image-49](draft-to-blog/image-49.png)

![image-50](draft-to-blog/image-50.png)

![image-51](draft-to-blog/image-51.png)
...
![image-52](draft-to-blog/image-52.png)

![image-53](draft-to-blog/image-53.png)

![image-54](draft-to-blog/image-54.png)

![image-55](draft-to-blog/image-55.png)
...
![image-56](draft-to-blog/image-56.png)

![image-57](draft-to-blog/image-57.png)

![image-58](draft-to-blog/image-58.png)

![image-59](draft-to-blog/image-59.png)

![image-60](draft-to-blog/image-60.png)

![image-61](draft-to-blog/image-61.png)
...
![image-62](draft-to-blog/image-62.png)

![image-63](draft-to-blog/image-63.png)

## 十三、附录

论文附录内容应包括支撑材料的文件列表

![image-64](draft-to-blog/image-64.png)

建模所用到的全部完整、可运行的源程序代码（含EXCEL、SPSS等软件的交互命令）等

![image-65](draft-to-blog/image-65.png)

![image-66](draft-to-blog/image-66.png)
...
![image-67](draft-to-blog/image-67.png)
